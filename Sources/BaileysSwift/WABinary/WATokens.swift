// Transliterated verbatim from Baileys' src/WABinary/constants.ts
// (WhiskeySockets/Baileys, MIT license). Do not hand-edit — regenerate
// via the token-extraction script if upstream bumps DICT_VERSION.

enum WATokens {
    static let singleByteTokens: [String] = [
        "",
        "xmlstreamstart",
        "xmlstreamend",
        "s.whatsapp.net",
    ...
    static let doubleByteTokens: [[String]] = [
        [
            "read-self",
            "active",
            "fbns",
